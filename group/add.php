...
session_start();
  if(isset($_SESSION["username"]) && isset($_SESSION["company_id"])){
	       if(isset($_POST['submit'])){
            ...
            $sql    = "INSERT INTO tbl_group (group_title,group_permission,status,createdby,createdon)
                       VALUES ('$group_title','$group_permission','$status','$createdby','$createdon')";
                    //    var_dump($sql);exit;
                                            ...
                                            <div class="card shadow">
                                                <div class="card-header">
                                                    ...
                                                    <div class="form-group col-md-4 float-right">
                                                        ...
                                                        <input type="text" class="form-control" name="group_title"  placeholder="Group Name" required>
                                                    </div>
                                                                ...
                                                                <?php 
                                                                        ...
                                                                        while($row = mysqli_fetch_array($result)){
                                                                            ?> <div class="col-md-2" style="border-right:1px solid #dae0ef;">
                                                                                            <!-- <span class="text-success lead"> <?php echo $row['menu_title'];?> </span> -->
                                                                                            <div class="form-group">
                                                                                                        <div class="custom-switches-stacked">
                                                                                                            <label class="custom-switch">
                                                                                                                <input type="checkbox" name="parmission[]" value="<?php echo $row['menu_url'];?>" class="custom-switch-input" checked="">
                                                                                                                <span class="custom-switch-indicator"></span>
                                                                            ...
                                                                            ?> 
                                                                                                <div class="form-group">
                                                                                                        <div class="custom-switches-stacked">
                                                                                                            <label class="custom-switch">
                                                                                                                <input type="checkbox" name="parmission[]" value="<?php echo $subrow['menu_url'];?>" class="custom-switch-input" checked="">
                                                                                                                <span class="custom-switch-indicator"></span>
